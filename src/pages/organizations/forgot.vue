      ...
      <template #footer>
        <div class="text-center">
          <p class="text-sm text-gray-600">
            <NuxtLink to="/organizations/login" class="text-blue-600 hover:underline">
...
// SEO
useHead({
  title: 'Відновлення паролю організації',
  meta: [{ name: 'description', content: 'Відновлення паролю для облікового запису організації' }],
});
</script>
